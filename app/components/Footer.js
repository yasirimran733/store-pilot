    ...
    <footer className="bg-slate-800 text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-lg font-semibold mb-4">About Store Pilot</h3>
            <p className="text-stone-300 text-sm">
              Your AI-powered shopping experience. Chat with our AI shopkeeper to find exactly what you're looking for.
            </p>
          </div>
        ...
        <div className="border-t border-stone-700 mt-8 pt-8 text-center text-sm text-stone-300">
          <p>&copy; 2024 Store Pilot. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
